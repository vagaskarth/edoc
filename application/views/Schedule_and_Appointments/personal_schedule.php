    ...
    <link rel="stylesheet" href="<?php base_url(); ?>../../css/fullcalendar.css" type="text/css" />
    <link rel="stylesheet" href="<?php base_url(); ?>../../css/fullcalendar.print.css" type="text/css" />
...
<div class="breadcrumb_container">
    <div class="row">
        <div class="btn-group btn-breadcrumb">
            ...
            <a href="<?php echo site_url('welcome/schedule_n_appointments'); ?>" class="btn btn-default">Schedule & Appointments</a>
            <a href="<?php echo site_url('welcome/personal_schedule'); ?>" class="btn btn-default"> Personal Schedule</a>
        </div>
    </div>
</div>

<hr class="first" style="margin-bottom: 60px;">
<br>
  ...
  $(document).ready(function() {
    ...
    */    
    ...
    var calendar =  $('#calendar').fullCalendar({
      ...
      /** MAO DIAY NI ANG MGA EVENTS I.REMOVE LANG ANG COMMENT PARA MAKITA ANG SAMPLE EVENT 
