...
<div class="breadcrumb_container">
    <div class="row">
        <div class="btn-group btn-breadcrumb">
            ...
            <a href="#" class="btn btn-default"> Daily Appointments</a>
        </div>
    </div>
</div>
    ...
    <div class="col-md-6">
        ...
        <label for="status">Status</label>
            <select id="subject" name="gender" class="form-control" required="required" style="width: 225px">
                ...
                <option name="status">All Appointment Statuses</option>
              ...
              <div class="panel-heading">
                <div class="row">
                  <div class="col col-xs-6">
                    <h3 class="panel-title">Daily Appointments</h3>
                  </div>
                  <div class="col col-xs-6 text-right">
                    <a href="<?php echo site_url('welcome/add_appointment'); ?>" type="button" class="btn btn-sm btn-primary btn-create">Add Appointment</a>
                  </div>
                </div>
              </div>
