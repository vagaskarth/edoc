...
<br>
<div class="container">
Patient Name: <strong><?= "{$patient['fname']} {$patient['lname']}"?></strong> <br>
Birthdate:  <strong><?= "{$patient['bday']}"?></strong><br>
Gender: <strong><?= "{$patient['gender']}"?></strong><br>
Blood Type: <strong><?= "{$patient['bloodtype']}"?></strong><br>
</div>
<br><br><br>
            <div class="container" style="width:1000px;">
                <div class="row">
                  ...
                  <tbody>
                          ...
                          <tr>
                            <td colspan="4">
                                <p class="reminder"> no records found click edit icon to add data. </p>
                            </td>
